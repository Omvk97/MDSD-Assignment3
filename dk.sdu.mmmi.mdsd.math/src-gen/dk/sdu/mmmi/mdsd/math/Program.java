 ...
 *   <li>{@link dk.sdu.mmmi.mdsd.math.Program#getExternalMethods <em>External Methods</em>}</li>
...
public interface Program extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>External Methods</b></em>' containment reference list.
   * The list contents are of type {@link dk.sdu.mmmi.mdsd.math.ExternalMethod}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>External Methods</em>' containment reference list.
   * @see dk.sdu.mmmi.mdsd.math.MathPackage#getProgram_ExternalMethods()
   * @model containment="true"
   * @generated
   */
  EList<ExternalMethod> getExternalMethods();
